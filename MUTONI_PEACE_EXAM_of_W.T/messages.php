...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO messages(Message_ID, Sender_ID, Receiver_ID, Message_Content, Timestamp) VALUES (?, ?, ?, ?, ? )");
    $stmt->bind_param("issss", $Message_ID, $Sender_ID, $Receiver_ID, $Message_Content,$Timestamp);

    
    // Set parameters and execute
    $Message_ID = $_POST['driver_id'];
    $Sender_ID = $_POST['user_id'];
    $Receiver_ID = $_POST['license_number'];
    $Message_Content = $_POST['car_model'];
    $Timestamp = $_POST['capacity'];
...
<body>
    <center><h2>Messages Table</h2></center>
    <table border="3">
        <tr>
...
// Prepare SQL query to retrieve all messages
